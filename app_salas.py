...
def relatorio(simulacao_id):
    ...
    for categoria, itens in CATEGORIAS_CUSTOS.items():
        titulo_categoria = categoria.replace('_', ' ').title()
        icon = categoria_icons.get(categoria, 'question-circle')
        
        custos_html += f'''
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-header bg-secondary text-white">
                    <h6 class="mb-0"><i class="fas fa-{icon}"></i> {titulo_categoria}</h6>
                </div>
                <div class="card-body">
        '''
